...
| ADMIN-ROOM-TYPE-01 | `POST /admin/room-types`                           | Admin             | Required support   | Create a unique room-type reference                                                                                                                                                                                                    |
| ADMIN-ROOM-TYPE-02 | `GET /admin/room-types`                            | Admin             | Required support   | Search and paginate room types                                                                                                                                                                                                         |
| ADMIN-ROOM-TYPE-03 | `GET /admin/room-types/:roomTypeId`                | Admin             | Required support   | Inspect one room type                                                                                                                                                                                                                  |
| ADMIN-ROOM-TYPE-04 | `PATCH /admin/room-types/:roomTypeId`              | Admin             | Required support   | Update room-type display data                                                                                                                                                                                                          |
| ADMIN-ROOM-TYPE-05 | `DELETE /admin/room-types/:roomTypeId`             | Admin             | Required support   | Delete only while no room references the type                                                                                                                                                                                          |
| ADMIN-AMENITY-01   | `POST /admin/amenities`                            | Admin             | Required support   | Create a unique uppercase amenity code                                                                                                                                                                                                 |
| ADMIN-AMENITY-02   | `GET /admin/amenities`                             | Admin             | Required support   | Search and paginate amenities                                                                                                                                                                                                          |
| ADMIN-AMENITY-03   | `GET /admin/amenities/:amenityId`                  | Admin             | Required support   | Inspect one amenity                                                                                                                                                                                                                    |
| ADMIN-AMENITY-04   | `PATCH /admin/amenities/:amenityId`                | Admin             | Required support   | Update amenity code/display data                                                                                                                                                                                                       |
| ADMIN-AMENITY-05   | `DELETE /admin/amenities/:amenityId`               | Admin             | Required support   | Delete only while no room assignment references the amenity                                                                                                                                                                            |
...
| ADMIN-FILE-01      | `POST /admin/rooms/:roomId/images`                 | Admin             | Required technique | Upload `THUMBNAIL`/`ALBUM` attachment with generated cloud key; `201`; per-uploader budget answers `429 ATTACHMENT_UPLOAD_RATE_LIMITED` before the body is read, an unreachable or stalled limiter `503 ATTACHMENT_UPLOAD_UNAVAILABLE` |
